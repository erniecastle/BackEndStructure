...
* Compañía: Macropro
* Descripción del programa: Clase ContactosDAO para llamados a metodos de Entity
* -----------------------------------------------------------------------------
* MODIFICACIONES:
* -----------------------------------------------------------------------------
* Clave: 
...
{
    public class ContactosDAO : GenericRepository<Contactos>, ContactosDAOIF
    {
        private StringBuilder concatena = new StringBuilder(200);
        private StringBuilder msgError = new StringBuilder().Append("Exitosw.Payroll.Core").Append(".MSERR_C_").Append(MethodBase.GetCurrentMethod().DeclaringType.Name).Append(".");


        public Mensaje agregar(Contactos entity, DBContextAdapter dbContext)
        {
            try
            {
                ...
                getSession().Set<Contactos>().Add(entity);
        ...
        public Mensaje modificar(Contactos entity, DBContextAdapter dbContext)
        {
            try
            {
                inicializaVariableMensaje();
                setSession(dbContext.context);
                getSession().Database.BeginTransaction();
                getSession().Set<Contactos>().AddOrUpdate(entity);
                getSession().SaveChanges();
        ...
        public Mensaje eliminar(Contactos entity, DBContextAdapter dbContext)
        {
            try
            {
                inicializaVariableMensaje();
                setSession(dbContext.context);
                getSession().Database.BeginTransaction();
                getSession().Set<Contactos>().Attach(entity);
                getSession().Set<Contactos>().Remove(entity);
                getSession().SaveChanges();
                mensajeResultado.resultado = true;
                mensajeResultado.noError = 0;
                mensajeResultado.error = "";
